...
@IBDesignable  class FlashOFF: UIButton {
    ...
    override func drawRect(rect: CGRect) {
        ...
        rectanglePath.moveToPoint(CGPointMake(3, 15))
        rectanglePath.addLineToPoint(CGPointMake(8.6, 15))
        rectanglePath.addLineToPoint(CGPointMake(10, -1))
        rectanglePath.addLineToPoint(CGPointMake(10, 0))
        rectanglePath.addLineToPoint(CGPointMake(3, 15))
        ...
        CGContextTranslateCTM(context, 13, 27)
        ...
        //// Text Drawing
        let textRect = CGRectMake(13, 15, 13, 11)
        ...
        "OFF".drawInRect(textRect, withAttributes: textFontAttributes)
